...
class MY_Model extends CI_Model {
	...
	protected $before_assign	= [];	// Callback before assigning
	protected $after_assign		= [];	// Callback after assigning
	protected $before_insert	= [];	// Callback before the creation
	protected $after_insert		= [];	// Callback after the creation
	protected $before_update	= [];	// Callback before updating
	protected $after_update		= [];	// Callback after updating
	protected $before_get		= [];	// Callback before selecting
	protected $after_get		= [];	// Callback after selecting
	protected $before_delete	= [];	// Callback before deleting
	protected $after_delete		= [];	// Callback after deleting
	 ...
	 * @return array
	 */
	private function _run_callbacks($moment, $operation, $parameters = []) {

		// Take data
		$data = isset($parameters[0]) ? $parameters[0] : [];
	 ...
	 * @return object
	 */
	public function increase_by($field, $where = []) {
		return $this->db
