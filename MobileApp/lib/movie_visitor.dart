...
class SingleMovieVisitor extends StatefulWidget {

  @override
  _SingleMovieVisitorState createState() => _SingleMovieVisitorState();
}

class _SingleMovieVisitorState extends State<SingleMovieVisitor> {
  var movie;
  var token;
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Text('Movie Hatke Stays', style: TextStyle(
                                ...
                                child: TabBarView(
                                  children: [
                                    Container(
                                        ...
                                        child: Text('this is a demo movie',
                                          style: TextStyle(
                                              color: textColor
                                          ),
                                        )
